<?php
   ...
   if(isset($_POST['create'])){
      ...
      $insert_into_coordinator = $conn->prepare("INSERT INTO students (student_id, first_name, last_name, age, gender, coordinator_id) VALUES (:student_id, :first_name, :last_name, :age, :gender, :coordinator_id)");
      ...
      if ($insert_into_users && $insert_into_coordinator) {
         $_SESSION['success'] = 'Student ' . $first_name . ' ' . $last_name . ' created successfully';
      ...
      <div id="content" class="container-fluid">
         ...
         <div class="card shadow mb-4">
            <div class="card-header d-flex align-items-center">
               <h1 class="h3 mb-2 text-gray-800"><i class="fas fa-building"></i> Create Student</h1>
            </div>
            <div class="card-body">
                  ...
                  <div class="row mb-3">
                     <div class="col-md-12">
                        ...
                        <select name="coordinator_id" id="coordinator_id" class="form-control">
                           ...
                           <?php
                              $coordinators = $conn->query("SELECT * FROM coordinators");
                              while($coordinator = $coordinators->fetch(PDO::FETCH_OBJ)) : ?>
                           ...
                           <?php 
                              // last selected
                              if(isset($_POST['coordinator_id']) && $_POST['coordinator_id'] == $coordinator->coordinator_id){
                                 echo '<option value="'.$_POST['coordinator_id'].'" selected>'.$coordinator->first_name.' '.$coordinator->last_name.'</option>';
                              }
                              endwhile;
                           ?>
                        </select>
