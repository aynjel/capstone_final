<?php
   ...
   $c_stmt->execute();
   $coordinators = $c_stmt->fetchAll(PDO::FETCH_OBJ);
      ...
      <div id="content" class="container-fluid">
         ...
         <div class="card shadow mb-4">
            <div class="card-header">
               <h1 class="h4 text-gray-800"><i class="fas fa-building-user"></i> Coordinators</h1>
               ...
               <div class="row">
                  ...
                  <div class="col-lg-4 col-md-6 mb-4">
                     <div class="card h-100">
                        <div class="card-body">
                           <h4 class="card-title">
                              <a href="show.php?id=<?php echo $coordinator->coordinator_id; ?>">
